use crate::{
    ...
    http,
    queries::aerocloud::{
        ProjectV7WithSimulations, SimulationQuality,
        SimulationsInProjectV7Arguments, SimulationsInProjectV7Query, Speed,
    },
};
...
pub async fn run(
    ...
    let op_args = SimulationsInProjectV7Arguments {
    ...
    let op = SimulationsInProjectV7Query::build(op_args);
...
fn print_human(project: &ProjectV7WithSimulations) {
