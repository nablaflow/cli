use crate::{
    ...
    queries::aerocloud::{
        CreateProjectV7Mutation, CreateProjectV7MutationParams, InputProjectV7,
    },
};
...
pub async fn run(
    ...
    let op_params = CreateProjectV7MutationParams {
    ...
    let op = CreateProjectV7Mutation::build(op_params);
