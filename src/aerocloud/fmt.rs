...
pub const fn human_simulation_status(v: SimulationStatus) -> &'static str {
    match v {
...
pub const fn human_boundary_layer_treatment(
    v: BoundaryLayerTreatment,
) -> &'static str {
    match v {
...
pub const fn human_symmetry(v: Symmetry) -> &'static str {
    match v {
        Symmetry::Off => "off",
