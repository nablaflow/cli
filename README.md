...
```bash
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/nablaflow/cli/releases/download/v1.6.0/nf-installer.sh | sh
```

#### Windows

```bash
powershell -ExecutionPolicy Bypass -c "irm https://github.com/nablaflow/cli/releases/download/v1.6.0/nf-installer.ps1 | iex"
```
...
nix run github:nablaflow/cli/v1.6.0
```
