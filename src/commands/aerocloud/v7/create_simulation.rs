use crate::{
    ...
    http,
    queries::aerocloud::{
        self, CreateSimulationV7Mutation, CreateSimulationV7MutationParams,
        GroundOffset, InputGroundV7, InputSimulationQuality, InputSimulationV7,
        Speed, YawAngle,
    },
};
...
impl From<Ground> for InputGroundV7 {
...
impl TryFrom<Simulation> for InputSimulationV7 {
...
pub async fn run(
    ...
    let op =
        CreateSimulationV7Mutation::build(CreateSimulationV7MutationParams {
